...
# └ latent (neighbour) change model (on one theory practice model) ####
  ...
  ## simulating and estimating latent-change model (factor loadings derived from BilWiss)
    ...
    # the script takes quite long, so here is the resulting table
      #> samplesize change1.1 change1.2   rmsea        cfi         tli         srmr
      #>  65        0.674     0.746       0.08001052   0.8350434   0.8285105   0.11072384
      #>  70        0.700     0.772       0.07505339   0.8425267   0.8362902   0.10954387
      #>  75        0.758     0.788       0.07160448   0.8493877   0.8434229   0.10311820
      #>  80        0.794     0.840       0.06869192   0.8744164   0.8694428   0.10185136
      #>  85        0.816     0.868       0.06531191   0.8816630   0.8769764   0.09693350
      #>  90        0.824     0.878       0.06653031   0.8808721   0.8761542   0.09519417
      #>  95        0.842     0.890       0.05985580   0.8964202   0.8923180   0.09157936
      #> 100        0.866     0.924       0.05977509   0.8985652   0.8945480   0.09004843
